	...
	for (var j = 0; j < (myroute.overview_path.length - 1); j++) {	
		...
		for (var a = 0; a < dbPeajes.length; a++) {
			...
			if (result == true) {
				...
				contents += '<div class="ej4" style="float:left; width:55px; height:100%; display:none;"><span style="text-align: right">$ ' + dbPeajes[a][15].ej4.valle + '</span></div><div class="ej4" style="float:left; width:55px; height:100%; display:none; clear:right;"><span style="text-align: right">$ ' + dbPeajes[a][15].ej4.pico + '</span></div>';
				contents += '<div class="ej5" style="float:left; width:55px; height:100%; display:block;"><span style="text-align: right">$ ' + dbPeajes[a][15].ej5.valle + '</span></div><div class="ej5" style="float:left; width:55px; height:100%; display:block; clear:right;"><span style="text-align: right">$ ' + dbPeajes[a][15].ej5.pico + '</span></div>';
