...
function calcularPeaje2(result, indice) {
	...
	contents += '<div class="ej5" style="float:left; width:54px; height:100%; text-align: right; display:block;">$ ' + (ejesTotal.ej5).toFixed(2) + '</div><div class="ej5" style="float:left; width:54px; height:100%; text-align: right; display:block; clear:right;"> </div>';
	contents += '<div class="ej6" style="float:left; width:54px; height:100%; text-align: right; display:none;">$ ' + (ejesTotal.ej6).toFixed(2) + '</div><div class="ej6" style="float:left; width:54px; height:100%; text-align: right; display:none; clear:right;"> </div>';
...
if ("ga" in window) {
    tracker = ga.getAll()[0];
    if (tracker)
        tracker.send("event", "Busqueda", "Obtener Indicaciones - MISig", indicacionesHitos);
}
	...
	//ga('send', 'event', 'Click', 'Obtener Indicaciones - miSIG', indicacionesHitos, {
//		'hitCallback': function() {
 //   			alert('analytics done sending data');
 // 		}
//	});
}
